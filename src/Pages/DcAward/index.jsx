            ...
            <Col xs={24} sm={24} md={23} lg={23}>
              ...
              <Row>
                <Text className={style.MainRowText}>
                  ...
                  and influential partners who consistently support and enrich our organization’s mission.
                  ...
                  their expertise, time, and leadership to the organization’s initiatives.
                  ...
                  In awarding these two levels of recognition—the prestigious Gold Award and the respected
                  Silver Award—the Diplomacy Community demonstrates its commitment to celebrating diplomatic
                  excellence at all levels of international leadership and cooperation. The awards reinforce
                  our organization’s core belief that successful diplomacy depends on the collective efforts
            ...
            <Col xs={24} sm={24} md={24} lg={24}>
              <Collapse
                ...
                items={[
                  {
                    key: '1',
                    label: <Text className={style.MainRowTitle}>🥇 Gold Award</Text>,
                  ...
                  {
                    key: '2',
                    label: <Text className={style.MainRowTitle}>🥈 Silver Award</Text>,
                    children:
